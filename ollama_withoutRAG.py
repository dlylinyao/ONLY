...
class SatiricalDictionaryOllamaNoRAG:
    def __init__(self, model_name="llama3"):
        ...
        self.system_prompt_normal = (
            ...
            "CRITICAL RULE: You must use SPECIFIC IRONY typical for Finnish culture.\n"
            "Style Guidelines:\n"
            "1. Cynical and Dark.\n"
    ...
    def ingest_context_list(self, context_list):
        ...
        if not self.context_chunks:
            ...
            print(
                f"[INFO] Successfully loaded {len(self.context_chunks)} chunks of context."
            )
...
if __name__ == "__main__":
    rag_system = SatiricalDictionaryOllamaNoRAG(model_name="llama3")
